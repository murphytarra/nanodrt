...
class Optimizer(eqx.Module):
    ...
    def __init__(
        ...
        Args:
            ...
            integration_method: Method used in simulation process to determine the impedance.
            solver_dict (dict): Dictionary of values used for optimization process. Dictionary types depend on process used.
